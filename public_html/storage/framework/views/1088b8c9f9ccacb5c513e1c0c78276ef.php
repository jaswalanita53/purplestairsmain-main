                    ...
                    <div class="seacrh_details_describe">
                        <div class="row seacrh_details_describe_row">
                            ...
                            <div class="col-lg-4 seacrh_details_describe_col_rtt">
                                <a href="javascript:void(0)" class="edit_search" >edit Search
                        ...
                        <div class="modal-content">
                            <form wire:submit.prevent="saveSearch()" id="update-search-form">
                                <div class="modal-body ">
                                    ...
                                    <?php if($archive_search_message): ?>
                                    <div class="alert alert-purple mt-3" role="alert">
                                        <?php echo e($archive_search_message); ?>
                                ...
                                <div class="modal-footer- py-5 px-3">
                                    ...
                                    <a href="javascript:;" class="btn btn-secondary float-left archive-search" wire:click="deleteSearch(<?php echo e($search->id); ?>)">Archive Search</a>
                        ...
                        <div class="col-xl-8 col-lg-6 view_cancidate_all_set_col_rtt">
                            <div class="view_cancidate_all_set_col_rtt_innr">
                                <div class="suggestion_search_wrapper">
                                    <ul>
                                        <li>
                                            <a href="javascript:;" class="<?php echo e($category == 'favorites' ? 'active' : ''); ?>" wire:click="filterByCategory('<?php echo e($category == 'favorites' ? '' : 'favorites'); ?>')">
                        ...
                        <div class="listgrid_cnt  <?php echo e(($active_tab==2) ? 'active' : ''); ?> candidate_box_parent" id="content-2">
                            ...
                            <!-- <div class="listview_candidate_details_w "> -->
                                ...
                                <div class="listview_candidate_details row mx-0  <?php echo e($hired_employee); ?>" data-url="<?php echo e(route('company.candidateprofile', ['user_id' => $candidate->id])); ?> " data-id="<?php echo e($candidate->id); ?>">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-6 mb-2 mb-md-0">
                                        ...
                                        <div class="modal fade inline-table-modal" id="send-request-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                            ...
                            <div class="listview_candidate_details_w candidate-card" data-id="<?php echo e($candidate->id); ?>">
                                <div class="listview_candidate_details" data-url="<?php echo e(route('company.candidateprofile', ['user_id' => $candidate->id])); ?> " data-id="<?php echo e($candidate->id); ?>">
                                    ...
                                    <div class="gr_fl3" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal" >
                                        <?php if($candidate->companyStatus->first()): ?>
                                        <?php if($candidate->companyStatus->first()->pivot->status == 0): ?>
                                        <div class="pending_unmask">
                                            <i class="iconc"><img src="<?php echo e(asset('assets/be/images/clock.svg')); ?>" alt=""></i>
...
<script>
    ...
    $('#edit-search').on('hide.bs.modal', function(e) {
        window.livewire.find('<?php echo e($_instance->id); ?>').set('archive_search_message', null);
    });
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/app/resources/views/livewire/saved-search.blade.php ENDPATH**/ ?>