              ...
              <div class="row justify-content-center">
                <div class="col-md-5">
                  <div class="plan-card">
                    <h3>Employer</h3>
                    <figure>
                      <img src="<?php echo e(url('/')); ?>/assets/fe/images/p1.svg" alt="">
                    </figure>
                ...
                <div class="col-md-5">
                  <div class="plan-card">
                    <h3>Employer Plus</h3>
                    <figure>
                      <img src="<?php echo e(url('/')); ?>/assets/fe/images/p2.svg" alt="">
                    </figure>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin-5/Sites/purplestairsmain/app/resources/views/pages/pricing.blade.php ENDPATH**/ ?>