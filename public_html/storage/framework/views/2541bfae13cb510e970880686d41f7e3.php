...
<script>
  ...
  // $(function () {
    ...
    $('#employersTable').DataTable({
      "serverSide": true,
      "ajax":{
        url :"<?php echo e(route('admin.employers.data')); ?>",
        type: "POST",
        data: { 
      ...
      columns: [
        ...
        { data: null, orderable: false, render: function(data, type, row, meta) { 
          if(row.status == 1) {
            return '<a class="btn btn-danger btn-sm" href="<?php echo e(url('admin/employers/deactive')); ?>/'+row.id+'">Deny</a>';
          } else {
            return '<a class="btn btn-success btn-sm" href="<?php echo e(url('admin/employers/active')); ?>/'+row.id+'">Approve</a>';
          }
        } },
      ],
    });
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/resources/views/backend/users/list.blade.php ENDPATH**/ ?>