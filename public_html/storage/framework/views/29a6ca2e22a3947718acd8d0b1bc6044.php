    ...
    <tr>
        <td>
            <table align="center" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="devicewidth" width="620">
                ...
                <tr>
                    <td colspan="4" class="pad_01" style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height:22px; padding:0 24px 20px 24px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; text-align:left; line-height:22px;">As part of our commitment to keeping our available candidates up to date, we kindly request a quick confirmation regarding your current status on Purple Stairs.</span></td>
                </tr>
                <tr>
                    <td colspan="4" class="pad_01" style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height:22px; padding:0 24px 20px 24px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; text-align:left; line-height:22px;">If you do not take any action, your account will remain active and available for new job opportunities. However, if you have found a job or are currently not looking for employment, we kindly request that you put your account to sleep by <a href="<?php echo e(url('/account/sleep?re=account/sleep')); ?>">clicking here</a>.</span></td>
                </tr>
                <tr>
...
</div><?php /**PATH /var/www/html/app/resources/views/mail/notify_candidate.blade.php ENDPATH**/ ?>