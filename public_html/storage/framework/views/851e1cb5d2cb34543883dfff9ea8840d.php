    ...
    <section class="profile-banner cmn-gap pb-0 ban-up ">
        <div class="container">
          ...
          <div class="profile-outr">
            ...
            <img src="<?php echo e(asset('assets/fe/images/pr-b1.svg')); ?>" alt="" class="pic6" />
             <div class="skop_text_wrppt">
                <!-- <a href="<?php echo e(route('candidatestep4')); ?>" class="skip new"
                >Skip <em><img src="<?php echo e(asset('assets/fe/images/skip-arrw.svg')); ?>" alt="" /></em
              ></a> -->

              <a href="<?php echo e(route('candidatestep2')); ?>" class="back-btn-yellow skip"
                >
                <em class="margin-right-25px"><img src="<?php echo e(asset('assets/fe/images/prev.svg')); ?>" alt="" /></em
              >
                Back
            ...
            <ul class="m-list">
              <li class="m-list-li">
                <div class="manual-inr" wire:click="updateUploadType('file')">
                  <figure>
                    <img src="<?php echo e(asset('assets/fe/images/cd1.svg')); ?>" alt="" />
                  </figure>
              ...
              <li class="m-list-li" wire:click="updateUploadType('manual')">
                <div class="manual-inr">
                  <figure>
                    <img src="<?php echo e(asset('assets/fe/images/cd2.svg')); ?>" alt="" />
                  </figure>
              ...
              <li class="m-list-li" wire:click="updateUploadType('linkedin')">
                <div class="manual-inr">
                  <figure>
                    <img src="<?php echo e(asset('assets/fe/images/cd3.svg')); ?>" alt="" />
                  </figure>
        ...
        <div class="container">
          <div class="resume-outr">
            ...
            <div class="resume-inr">
              <figure>
                <img src="<?php echo e(asset('assets/fe/images/r1.svg')); ?>" alt="" />
              </figure>
              <h5>Drag and Drop Your Resume</h5>
              <div class="resume-warning">
                <span><img src="<?php echo e(asset('assets/fe/images/warning.svg')); ?>" alt="" /></span>
                <p>
              ...
              <div class="text-center mt-2">
                  <embed src="<?php echo e(asset($resume_path)); ?>" type="">
              </div>
              <?php endif; ?>
            ...
            <?php elseif($upload_type == 'linkedin'): ?>
            <form>
...
<script>
    ...
    $(".nxt-btn").click(function(e) {
        ...
        window.location.href='<?php echo e(url("/candidate/education")); ?>';
    })
</script>
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/app/resources/views/livewire/candidate-step3.blade.php ENDPATH**/ ?>