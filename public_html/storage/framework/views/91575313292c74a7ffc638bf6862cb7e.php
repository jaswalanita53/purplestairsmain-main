    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <?php echo Form::open(['method' => 'post', 'id' => 'discount_frm', 'route' => 'admin.discount.store']); ?>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="form-group <?php echo e(($errors->has('coupon_code')) ? 'has-error' : ''); ?>">
                  ...
                  <?php echo Form::text('coupon_code', old('coupon_code'), array('class'=> 'form-control', 'placeholder' => 'Enter Coupon Code')); ?>
              ...
              <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group <?php echo e(($errors->has('status')) ? 'has-error' : ''); ?>">
                  <label>Status</label>
                  <?php echo Form::select('status', ['1'=>'Active','0'=>'In-Active'], old('status'), array('class'=> 'form-control','width'=>'100%')); ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 form-group <?php echo e(($errors->has('discount_value')) ? 'has-error' : ''); ?>">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo e(old('discount_value')); ?>" name="discount_value" placeholder="Discount Value">
                  <div class="input-group-addon">
              ...
              <div class="col-md-6 col-sm-6">
                <div class="form-group <?php echo e(($errors->has('validity')) ? 'has-error' : ''); ?>">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" value="<?php echo e(old('validity')); ?>" class="form-control float-right" id="reservation" name="validity">
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-9 col-sm-6">
                    <div class="form-group <?php echo e(($errors->has('use_limit')) ? 'has-error' : ''); ?>">
                      ...
                      <input type="text" name="use_limit" class="form-control" id="use_limit" disabled placeholder="Set usage limit" value="<?php echo e(old('use_limit')); ?>">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/resources/views/backend/discount/add.blade.php ENDPATH**/ ?>