...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li> <a href="<?php echo e(URL('areaInterest')); ?>">AreaInterest
      </a></li>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-header">
            ...
            <div style="float: right;"><a class="btn bg-navy btn-flat margin" href="<?php echo e(URL('areaInterest')); ?>">
            AreaInterest
           </a></div>
           
         </div>
         <!-- /.box-header -->
         <?php echo Form::model($areaInterest); ?>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
             ...
             <div class="row">
              ...
              <!-- /.col -->
              <br> <br> <br> <br>
              <a  href="<?php echo e(URL('areaInterest/add')); ?>" class="btn bg-navy btn-flat margin" style="float: right;"><i class="ace-icon fa fa-undo bigger-110"></i> Cancel</a>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/demo.purplestairs.com/app/resources/views/backend/addAreaInterest.blade.php ENDPATH**/ ?>