<style type="text/css">
    ...
    .form-group.cvv .form-control {
        background-image: url('<?php echo e(asset('assets/fe/images/cvv.svg')); ?>');
                                ...
                                <div class="col-md-12 pay-form form-group mt-1">
                                    <div class="credit-card">
                                        <div class="cre-lft ">
                                            ...
                                            <div class="cre-pan">
                                                <input type="text" autocomplete="off" class="form-control ml-2 cc-width" wire:model.lazy="credit_card" id="credit_card" placeholder="2414 7512 3214 4575" minlength="17" maxlength="19" wire:keyup="validate_cc()" wire:keydown="validate_cc()"> 
                                    ...
                                    <div class="credit_card_error">
                                        ...
                                        <div class="text-danger" style="font-size: smaller;">
                                            <?php if($this->cc_error && $card_save): ?> <?php echo e($this->cc_error); ?> <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
                      <h5 class="mb-3 mt-4">EXP</h5>
                        <div class="col-3">
                          ...
                          <div class="form-group fg2- m-0">
                              <input type="text" class="form-control numbersInput" placeholder="MM" wire:model="exp_month" minlength="2" maxlength="2" min="1" wire:keyup="validate_cc()" wire:keydown="validate_cc()">
                              <?php echo $__env->make('inc.error', [
                            ...
                            <div class="text-danger" style="font-size: smaller;">
                                <?php if($this->cc_mon_error && $card_save): ?> <?php echo e($this->cc_mon_error); ?> <?php endif; ?>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-3">
                        <div class="form-group fg2- m-0">
                              <input type="text" class="form-control numbersInput" placeholder="YY" wire:model="exp_year" minlength="2" maxlength="2"  wire:keyup="validate_cc()" wire:keydown="validate_cc()">
                              <?php echo $__env->make('inc.error', [
                                'field_name' => 'exp_year'
                              ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                              ...
                              <div class="text-danger" style="font-size: smaller;">
                                <?php if($this->cc_yr_error && $card_save): ?> <?php echo e($this->cc_yr_error); ?> <?php endif; ?>
                              </div>
                          </div>
                        </div>
                        <div class="col-5">
                        ...
                        <div class="form-group cvv m-0" >
                              <input type="text" class="form-control numbersInput" placeholder="CVV Number" wire:model="cvv" minlength="3" maxlength="4">
                              <?php echo $__env->make('inc.error', [
                                'field_name' => 'cvv'
                              ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                          </div>
...
<?php /**PATH /var/www/html/app/resources/views/inc/add_card.blade.php ENDPATH**/ ?>