...
<script>
  ...
  // $(function () {
    ...
    $('#employersTable').DataTable({
      "serverSide": true,
      "ajax":{
        url :"<?php echo e(route('admin.deleted_account.data')); ?>",
        type: "POST",
        data: { 
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/resources/views/backend/users/deleted_list.blade.php ENDPATH**/ ?>