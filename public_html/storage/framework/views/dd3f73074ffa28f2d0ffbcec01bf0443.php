      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <a href="<?php echo e(URL('softSkills/add')); ?>" class="btn bg-navy btn-flat margin" style="float:right">Add Soft Skills</a>
          </div>

          <!-- /.box-header -->
          <div class="box-body">
            <form action="<?php echo e(URL('searchSoftSkills')); ?>" method="get" id="search-form" class="form-inline" role="form" style="float:right">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="project-actions">
                    <a class="btn btn-info btn-sm" href="<?php echo e(URL('softSkills/'.$skillDetail->id.'/edit')); ?>">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/demo.purplestairs.com/app/resources/views/backend/viewSoftSkills.blade.php ENDPATH**/ ?>