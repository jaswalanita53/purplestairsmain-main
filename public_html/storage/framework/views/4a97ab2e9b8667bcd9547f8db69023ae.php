...
// $(document).ready(function () {
    ...
    $('.case_slide_change').change(function () {
        ...
        $.ajax({
            url: '<?php echo e(url('login/set_usertype/')); ?>/' + isChecked,
            type: 'GET',
            dataType: 'html',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin-5/Sites/purplestairsmain/app/resources/views/auth/login.blade.php ENDPATH**/ ?>