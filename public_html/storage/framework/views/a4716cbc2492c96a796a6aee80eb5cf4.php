            ...
            <div class="container">
                <div class="log-wrap log-wrap2" style="background-image: url(assets/fe/images/log-back2.png)">
                    <div class="login-outr">
                        <h2>Hello!</h2>
                        <p class="blk-p mt-2 mb-2">Get started by creating an account.</p>
                        <form>
...
<?php $__env->startSection('js'); ?>
    <script>
        $(".sub2").click(function(e) {
            ...
            e.preventDefault();
            location.replace('signup-candidate'); //Task #86a0gbv9f
        });

        $(".sub3").click(function(e) {
            e.preventDefault();
            // location.replace('/employer/login');
            location.replace('/employer/signup'); // task -
        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/resources/views/pages/singupselect.blade.php ENDPATH**/ ?>