                    ...
                    <form wire:submit.prevent="saveProfile()" id="saveProfile">
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control user-name-field" wire:model.defer="employer_name" />
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control" wire:model.defer="company_name" />
                                <?php echo $__env->make('inc.error', [
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="email" placeholder="" class="form-control" wire:model.defer="company_email" readonly disabled/>
                                <?php echo $__env->make('inc.error', [
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control" wire:model.defer="company_address" />
                                <?php echo $__env->make('inc.error', [
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control" wire:model.defer="company_city"  />
                                <?php echo $__env->make('inc.error', [
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control zip_code_field" wire:model.defer="zip_code"   />
                                <?php echo $__env->make('inc.error', [
                                'field_name' => 'zip_code',
                                ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="xxx-xxx-xxxx" id="telle" maxlength="12" class="form-control" wire:model.defer="company_phone" />
                                <?php echo $__env->make('inc.error', [
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control" wire:model.defer="website_url" />
                                <?php echo $__env->make('inc.error', [
                        ...
                        <div class="gl-frm-outr">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="" class="form-control" wire:model.defer="social_media_url" />
                                <?php echo $__env->make('inc.error', [
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/app/resources/views/livewire/company-step1.blade.php ENDPATH**/ ?>