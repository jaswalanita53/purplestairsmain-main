        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb edit-personal justify-content-center justify-content-md-start">
                    <li class=" mb-2 mb-md-0"><a href="<?php echo e(route('candidates.editpersonal')); ?>">Edit Personal
                            Information</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select class="js-example-tags industries" multiple="multiple" wire:model.lazy="selectedIndustries" id="selectedIndustries">
                                    ...
                                    <option value=<?php echo e($ind); ?> <?php echo e(in_array($ind, $selectedIndustries) ? 'selected' : ''); ?>><?php echo e($key); ?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select class="js-example-tags interests" multiple="multiple" wire:model.lazy="selectedInterests" id="selectedInterests">
                                    ...
                                    <option value=<?php echo e($interest); ?> <?php echo e(in_array($interest, $selectedInterests) ? 'selected' : ''); ?>><?php echo e($key); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php echo $__env->make('inc.error', [
                            ...
                            <div class="form-sec-left form-group">
                                ...
                                <div class="form-group-for-custom-checkbox">
                                    <div class="form_input_check">
                                        <label>
                                            <input type="checkbox" wire:model.lazy="work_environment_remote" class="work_environment_checkbox work_environment_remote_checkbox"  <?php echo e($work_environment_remote ? 'checked' : ''); ?>/>
                                            <span>Remote</span>
                                        </label>

                                        <label>
                                            <input type="checkbox" wire:model.lazy="work_environment_in_office" class="work_environment_checkbox" <?php echo e($work_environment_in_office ? 'checked' : ''); ?>/>
                                            <span> In Office</span>
                                        </label>

                                        <label>
                                            <input type="checkbox" wire:model.lazy="work_environment_hybrid" class="work_environment_checkbox" <?php echo e($work_environment_hybrid ? 'checked' : ''); ?>/>
                                            <span>Hybrid</span>
                                        </label>
                                    </div>
                                </div>
                                <?php if($work_env_error): ?>
                                <div class="text-danger"><?php echo e($work_env_error); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-sec-left form-group">
                                ...
                                <div class="text-danger"><?php echo e($schedule_error); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-sec-left form-group">
                                ...
                                <?php if($compensation_error): ?>
                                <div class="text-danger"><?php echo e($compensation_error); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="slide-sec-rgt">
                                <div class="row">
                                    <div class="col-lg-12 slider-total-sec-col" style="display: <?php echo e(($work_environment_in_office || $work_environment_hybrid || (!$work_environment_in_office && !$work_environment_hybrid && !$work_environment_remote)) ? 'block' : 'none'); ?>" wire:ignore.self>
                                        <div class="form-group">
                                            <div class="slider-total-sec">
                                                ...
                                                <br>
                                                <input type="hidden" name="distance" id="distance" value="<?php echo e($distance); ?>" wire:ignore>
...
<script>
    ...
    $('#savePreferences').on('submit', function(event) {
        window.livewire.find('<?php echo e($_instance->id); ?>').set('distance', $("#distance").val());
    });
    ...
    document.addEventListener("livewire:load", () => {
        Livewire.hook('message.processed', (message, component) => {
            ...
            console.log(window.livewire.find('<?php echo e($_instance->id); ?>').get('selectedIndustries'));
            let indust = window.livewire.find('<?php echo e($_instance->id); ?>').get('selectedIndustries');
            let inter = window.livewire.find('<?php echo e($_instance->id); ?>').get('selectedInterests');
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/app/resources/views/livewire/candidate-edit-preferences.blade.php ENDPATH**/ ?>