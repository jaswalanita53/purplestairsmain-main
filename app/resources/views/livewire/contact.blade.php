      ...
      <div class="banner-outr">
        <div class="row align-items-center">
          <div class="col-sm-6 pr-col">
            <div class="ban-lft">
              <div class="ban-hdr">
                ...
                <img src="{{asset('assets/fe/images/pic2.svg')}}" alt="" class="pic1 des" />
              </div>
            </div>
          </div>
          <div class="col-sm-6  pr-col2">
            <div class="ban-rgt">
              <figure>
                <img src="{{asset('assets/fe/images/con-bck.png')}}" alt="" class="ban-dsng desktop-v"/>
                <img src="{{asset('assets/fe/images/con-mob.png')}}" alt="" class="ban-dsng mobile-v">
              </figure>
            </div>
          </div>
        </div>
  ...
  <div class="contact-sec cmn-gap pt-0">
    <div class="container">
      ...
      <div class="contact-outr">
        ...
        <img src="{{asset('assets/fe/images/cin1.png')}}" alt="" class="c-desng1">
        <img src="{{asset('assets/fe/images/cin2.png')}}" alt="" class="c-desng2">
         ...
         <div class="contact-top">
          <ul class="pt-2">
            {{-- <li>
              ...
              <figure>
                <img src="{{asset('assets/fe/images/con1.svg')}}" alt="" />
              </figure>
            </li> --}}
            <li>
              <div class="cont-top-lft ">
              ...
              <figure>
                <img src="{{asset('assets/fe/images/con2.png')}}" alt="" />
              </figure>
            </li>
          </ul>
        </div>
