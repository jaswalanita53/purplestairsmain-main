                    ...
                    <div class="add_searches_home">
                        <div class="row add_searches_home_row">
                            ...
                            <div class="col-lg-6 add_searches_home_col_rtt">
                                <a class="add_search_vbtn" href="javascript:void(0)" data-toggle="modal" data-target="#add-search"><span><i class="ic11"><img src="{{asset('assets/be/images/search_ic1.png')}}" alt=""></i>Add
                                    ...
                                    <div class="col-lg-6 saved_sc_accountant_outr_top_col_rght">
                                        <div class="dowpdown_click_bts">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item edit-search-btn" href="javascript:void(0)"  data-id="{{$searches['search']->id}}">
                                                        <i class="icon"><img src="{{asset('assets/be/images/search_e_ico.svg')}}" alt=""></i>Edit Search
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item deleteButton" href="#" data-id="{{$searches['search']->id}}">
                                                        <i class="icon"><img src="{{asset('assets/be/images/search_e_ico2.svg')}}" alt=""></i>Archive Search
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
