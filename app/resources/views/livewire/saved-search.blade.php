                        ...
                        <div class="row seacrh_details_describe_row">
                            <div class="col-lg-8 seacrh_details_describe_col_lft">
                                <h3 class="text-capitalize">{{ $search->name }}</h3>
                                                                {{-- //86a2zt9nn new match --}}
                                <span style="cursor:pointer" onclick="filterByCategory('')" class="saved-search-count py-1 px-3">{{ $candidates_count }} Candidate{{($candidates_count > 1) ? 's' : ''}}{{-- task - 86a26ba92 --}}</span>
                            ...
                            <div class="col-lg-4 seacrh_details_describe_col_rtt">
                                <a href="javascript:void(0)" class="edit_search" >edit Search
                                    <i><img src="{{ asset('assets/be/images/edit_sc.svg') }}" alt="" /></i></a>
                            </div>
                             <span>
                            @php
                            $showCount=0;
                            ...
                            <div class="listview_candidate_details_w candidate-card" data-id="{{$candidate->id}}">
                                <div class="listview_candidate_details" data-url="{{ route('company.candidateprofile', ['user_id' => $candidate->id]) }} " data-id="{{$candidate->id}}">
                                    ...
                                    <div data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal" >
                                        <div class="listview_candidate_details_img">
                                            {{-- @if($candidate->profile_photo_path)
                                            <img src="{{ asset($candidate->profile_photo_path) }}" alt="" />
                                            @else
                                ...
                                {{-- <small>{{ $candidate->personal->zip_code }}</small> --}}
                                   {{-- @endif --}}
                                    ...
                                    <div class="gr_fl3" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal" >
                                        ...
                                        @endif
                                        @else
                                        <a href="#url" class="req_mask_btn req_mask_btn_list" wire:click.prevent="sendRequest({{ $candidate->id }})">
                                            <i class="ic_req_m"><img src="{{ asset('assets/be/images/masked.svg') }}" alt="" /></i>
                                            <div class="req_mask_btn_rtt">Request Unmask</div>
                                        </a>
                                        @endif
