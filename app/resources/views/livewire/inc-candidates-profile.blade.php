...
<script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/12.1.6/js/intlTelInput.min.js"></script>
    ...
    <style>
        ...
        li.primary_ind_name {
         background: rgba(126, 80, 167, 0.2) !important;
        }
    </style>
    ...
    <div data-id="{{$candidate_user->id}}" class=" modal not_in_searches- fade condidate-profile-modal exampleModalToggle{{$candidate_user->id}}" aria-hidden="true" aria-label="exampleModalToggleLabel2" @if(!empty($candidate_user->id)) data-id={{$candidate_user->id}} @else data-id="" @endif tabindex="-1" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered modal-fullscreen- modal-xl" wire:ignore>
                                    ...
                                    <div class="container" style="/*padding: 0 95px;*/">
                                        <div class="preview_banner_total">
                                            <div class="preview-banner">
                                             ...
                                             {{-- 86a2zxgm6 --}}
                                                {{-- 86a2ym8bj --}}
                                                {{-- to maintain layout space --}}
                                                <br>
                                            {{-- 86a2zxgm6 --}}
                                            <div class="preview_banner_btm" style="position: relative;">
                                                {{-- @if($search_id) task - 86a2vx5er --}}
                                                <div class="candidate_grid_ppl_icn large" style="position: absolute; margin-top: 30px; z-index: 9;">
                                                {{-- 86a2ym8bj  --}}
                                                        ...
                                                        <div class="clickd_tgl_searches_open_ul arr_grey">
                                                            ...
                                                            @if(!empty($saved_searches))
                                                                ...
                                                                @php
                                                                    ...
                                                                    if(is_null($search_ids)) {
                                                                        $search_ids = [];
                                                                    }
                                                                    $is_checked = in_array($candidate_user->id, $search_ids) ? 1 : 0;
                                                                @endphp
                                                                <label>
                                                ...
                                                <div class="preview_banner_img_sec" @if($mode) style="align-items: center" @endif>

                                                    <div class="preview_banner_img_sec_left">
                                                        @if(!$mode)
                                                        <span class="preview-banner-txt ht ms-2">
                                                            <span class="preview-banner-txt-left">
                                                        ...
                                                        {{-- @endif --}}
                                                        {{-- @if($mode) --}}
                                                        @if($requestCompany && $candidate_user->companyStatus->first())
                                                            @if($candidate_user->companyStatus->first()->pivot->status == 0 || $candidate_user->companyStatus->first()->pivot->status == 2)
                                                                <div class="request_btn_otr-">
                                                                    ...
                                                                    <div class="pending_unmask">
                                                                        ...
                                                                        <div class="pending_unmask_rt pending_unmask_rt_view">
                                                            ...
                                                            @else
                                                                <div class="unmasked_div_ic mt-3">
                                                        ...
                                                        <div class="request_btn_otr">
                                                            ...
                                                            <div class="position_form" wire:ignore.self>
                                                                ...
                                                                <form wire:submit.prevent="incsendRequest()" class="mt-3">
                                                                    ...
                                                                    <div class="position-submit-btn-otr" wire:loading.remove wire:target="incsendRequest">
            ...
            {{-- task - 86a309hbq end --}}
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        <div class="defination_list">
                                                                            ...
                                                                            <ul>
                                                                                @if(!empty($industries))
                                                                                @foreach ($industries as $industry_name=>$primary_status)
                                                                                   <li class="@if($primary_status==1) primary_ind_name @endif" >{{ $industry_name }} </li>
                                                                                @endforeach
                                                                                @endif
                                                                            </ul>
                                                                        </div>
                                                            ...
                                                            <ul class="preview_contact_list">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="contact_rgt_side">
                                                                        ...
                                                                        @else
                                                                        <p class="d-flex flag-phone">
                                                                        <input type="hidden" class="ref-phone" value="{{$reference->phone}}" >
                                                                        <a href="tel:{{$reference->phone}}"   data-phone="{{$reference->phone}}">{{$reference->phone}}</a>
                                                                        </p>
                                                    ...
                                                    <div class="employer_note_block">
                                                        ...
                                                        <div class="add_btn_otr">
                                                            {{-- task - 86a22j70y <a data-fancybox data-src="#open55" href="javascript:;" class="add_btn">add a
                                                                note<span>+</span></a> --}}
                                                            <a onclick="$('.note_modal_{{$candidate_user->id}}').show(); reset_ev();" href="javascript:;" class="add_btn">add a
                                                                note<span>+</span></a>
                                                        </div>
                                                            ...
                                                            <ul class="add_note_list">
                                                                ...
                                                                <li class="active">
                                                                    <div class="add_note_list_item">
                                                                        <div class="add_note_list_item_head d-flex">
                                                                            <ul>
                                                                                <li>
                                                                            ...
                                                                            {{-- task - 86a39a7q5 --}}
                                                                            <button class="btn btn-sm btn-danger" type="button" onclick="deleteNote{{$candidate_user->id}}(this,{{$note->id}})">
                                            ...
                                            <form wire:submit.prevent="saveNote()">
                                                <div class="modal-note">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea wire:model.defer="note"></textarea>
                                                        @error('note')
                                                    ...
                                                    <div class="form-submit-btn mb-0 mt-3">
                                                        <input type="submit" value="Add" class="submit-btn" wire:loading.remove wire:target="saveNote" onclick="disable_btn_{{$candidate_user->id}}(this)">
                    ...
                    <script>
                        ...
                        // task - 86a39a7q5
                        function deleteNote{{$candidate_user->id}}(el,id) {
                        ...
                        window.addEventListener('close-note', event => {
                            // $.fancybox.close();
                            $('.note_modal_' + event.detail.hide_id).find('input[type=submit]').val('Save');
                    ...
                    <script>
                        ...
                        window.addEventListener('updateReqModal', event => {
                            // $.fancybox.close();
                            $('.condidate-profile-modal.show .request_btn_otr').html('<div class="pending_unmask"><i class="iconc"><img src="{{asset('assets/be/images/clock.svg')}}" alt=""></i><div class="pending_unmask_rt pending_unmask_rt_view"><h6>Pending Unmask</h6><p>Profile Saved In Requested</p></div></div>');
                        })
                        ...
                        window.addEventListener('save-note-update', event => {
                            if(!ev_f) {
                                console.log(ev_f);
                                $('.add_note_list').append('<li class="active"><div class="add_note_list_item"><div class="add_note_list_item_head"><ul><li><span><img src="{{asset('assets/fe/images/prpl_calender.svg')}}" alt=""></span>'+ event.detail.date +'</li></ul></div><div class="add_note_list_item_content">'+ event.detail.note +'</div><div class="add_note_list_item_ftr"><h6><span><img src="{{asset('assets/fe/images/demo_avatar.svg')}}" alt=""></span>'+ event.detail.username +'</h6></div></div></li>');
                            }
                            ev_f = 1;
                        });
                        ...
                        $(document).ready(function() {
                            ...
                            $('.condidate-profile-modal').on('show.bs.modal', function (e) {
                                console.log('Modal shown');
                                setTimeout(function() {
                                    $(".ref-phone").each(function() {
                                        let input = $(this);
                                        input.intlTelInput('destroy');
                                        input.intlTelInput();
                                         console.log('here',input.find('.selected-flag').attr('title'));
                                    });
