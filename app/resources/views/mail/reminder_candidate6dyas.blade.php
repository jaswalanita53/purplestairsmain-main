    ...
    <tr>
        <td>
            <table align="center" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" class="devicewidth" width="620">
                ...
                <tr>
                    <td colspan="4" class="pad_01" style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height:22px; padding:27px 24px 20px 24px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; text-align:left; line-height:22px;">Dear {{ ucfirst(strtolower($name)) }}, <br> <br>
                    Purple Stairs is buzzing with opportunities, and employers are actively seeking candidates like you.  </span></td>
                </tr>
                <tr>
                    <td colspan="4" class="pad_01" style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height:22px; padding:0 24px 20px 24px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; text-align:left; line-height:22px;">
                    Take this chance to ensure your profile is complete and active. Don't miss out on potential connections and exciting job prospects. If you have any questions or need assistance, we're here to help.<br> <br>
                   This is our final reminder to you. We eagerly anticipate facilitating new connections and opportunities for you through Purple Stairs.
                    </span></td>
                </tr>

                <tr>
                    <td colspan="4" class="pad_01" style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; text-align:center; line-height:50px; padding:0 24px 20px 24px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; text-align:center; line-height:22px;"><a href="{{url('/')}}/candidate/edit/personal" style="color: white; text-decoration: none; background: #82609f; padding: 15px 45px;font-weight: 600;font-size: 18px;border-radius:35px;">CLICK HERE</a></span></td>
                </tr>
                <tr>
                    <td colspan="4" class="pad_01" style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; text-align:left; line-height:22px; padding:0 24px 20px 24px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; text-align:left; line-height:22px;"><br/>The Purple Stairs Team</span></td>
                </tr>
                <tr>
