      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Employer Deleted Accounts</h3>
          </div>
...
<script>
  ...
  // $(function () {
    ...
    $('#employersTable').DataTable({
      "serverSide": true,
      "ajax":{
        url :"{{ route('admin.deleted_account.data') }}",
        type: "POST",
        data: {
          '_token': '{{ csrf_token() }}',
      ...
      columns: [
        ...
        { data: null, orderable: false, render: function(data, type, row, meta) {
          let _actions = "";
          _actions +='<a class="btn btn-success btn-sm" href="{{ url('admin/sleep_account/activate') }}/'+row.id+'">Activate</a> '; // task - 86a1hvak1
