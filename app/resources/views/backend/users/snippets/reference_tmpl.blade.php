<div class="row ref-row" id="reference-first-row">
	<div class="col-md-12 col-xs-12 col-lg-12 text-right remove-ref-btn" style="display: none;">
	...
	<div class="col-md-6 col-xs-12 col-lg-6 form-group">
		...
		<div class="input-group">
		  <input type="text" class="form-control" name="ref_relationship[]">
		  <span class="input-group-addon">
		    Hidden To Everyone
		  </span>
		</div>
	...
	<div class="col-md-6 col-xs-12 col-lg-6 form-group">
		<label>Phone</label>
		<div class="input-group">
		  <input type="text" class="form-control phone_input" name="ref_phone[]">
		  <span class="input-group-addon">
		    Hidden To Everyone
		  </span>
		</div>
