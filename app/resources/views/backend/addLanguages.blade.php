...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li> <a href="{{ URL('languages') }}">Languages
      </a></li>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-header">
            ...
            <div style="float: right;"><a class="btn bg-navy btn-flat margin" href="{{ URL('languages') }}">
            Languages
           </a></div>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
             ...
             <div class="row">
              ...
              <!-- /.col -->
              <br> <br> <br> <br>
              <a  href="{{ URL('languages/add') }}" class="btn bg-navy btn-flat margin" style="float: right;"><i class="ace-icon fa fa-undo bigger-110"></i> Cancel</a>
