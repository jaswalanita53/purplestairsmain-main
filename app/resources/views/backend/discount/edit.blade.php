    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          {!! Form::open(['method' => 'post', 'id' => 'discount_frm', 'route' => ['admin.discount.update', $discount->id]]) !!}
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="form-group {{ ($errors->has('coupon_code')) ? 'has-error' : ''}}">
                  ...
                  {!! Form::text('coupon_code', old('coupon_code', $discount->coupon_code), array('class'=> 'form-control', 'placeholder' => 'Enter Coupon Code'))!!}
              ...
              <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group {{ ($errors->has('status')) ? 'has-error' : ''}}">
                  <label>Status</label>
                  {!! Form::select('status', ['1'=>'Active','0'=>'In-Active'], old('status', $discount->status), array('class'=> 'form-control','width'=>'100%'))!!}
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 form-group">
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12">
                    <input type="radio" name="discount_type" id="r_per" {{$discount->type == 'percentage' ? 'checked' : ''}} value="percentage">
                    Percentage
                  </div>

                  <div class="col-md-6 col-sm-12">
                    <input type="radio" name="discount_type" id="r_fix" {{$discount->type == 'fixed' ? 'checked' : ''}} value="fixed">
                    Fixed
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-sm-6 form-group {{ ($errors->has('discount_value')) ? 'has-error' : ''}}">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="{{ old('discount_value', $discount->discount_value) }}" name="discount_value" placeholder="Discount Value">
                  <div class="input-group-addon">
              ...
              <div class="col-md-6 col-sm-6">
                <div class="form-group {{ ($errors->has('validity')) ? 'has-error' : ''}}">
                  ...
                  <div class="input-group">
                    ...
                    @endphp
                    <input type="text" value="{{ old('validity', $validity) }}" class="form-control float-right" id="reservation" name="validity">
                  </div>
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6">
                    <div class="form-group" style="line-height: 5;">
                      One Time Use
                      <input type="checkbox" class="" name="one_time_used" {{$discount->one_time_only == '1' ? 'checked' : ''}} value="1">
                    </div>
                  </div>
                  <div class="col-md-9 col-sm-6">
                    <div class="form-group {{ ($errors->has('use_limit')) ? 'has-error' : ''}}">
                      <label>Set Limit</label>
                      <input type="text" name="use_limit" class="form-control" id="use_limit" disabled placeholder="Set usage limit" value="{{ old('use_limit', ($discount->one_time_only != '1' && $discount->maximum_allow) ? $discount->maximum_allow : '') }}">
        ...
        <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="form-group {{ ($errors->has('discount_duration')) ? 'has-error' : ''}}">
                  ...
                  {!! Form::number('discount_duration', old('discount_duration', $discount->discount_duration), array('class'=> 'form-control', 'placeholder' => 'Enter Coupon Code'))!!}
