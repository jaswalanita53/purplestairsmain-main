      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <a href="{{ URL('hardSkills/add') }}" class="btn bg-navy btn-flat margin" style="float:right">Add Hard Skills</a>
          </div>

          <!-- /.box-header -->
          <div class="box-body">
            <form action="{{ URL('searchHardSkills') }}" method="get" id="search-form" class="form-inline" role="form" style="float:right">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="project-actions">
                    <a class="btn btn-info btn-sm" href="{{ URL('hardSkills/'.$skillDetail->id.'/edit')}}">
