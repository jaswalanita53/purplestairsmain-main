      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <a href="{{ URL('industries/add') }}" class="btn bg-navy btn-flat margin" style="float:right">Add Industries</a>
          </div>

          <!-- /.box-header -->
          <div class="box-body">
            <form action="{{ URL('searchIndustries') }}" method="get" id="search-form" class="form-inline" role="form" style="float:right">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <!-- /.modal -->
              <tbody>
                @foreach ($industriesList as $industryDetail)
                <tr>
                  <td>{{ $industryDetail->name }}</td>
                  <td>
                    @if($industryDetail->status == 1)
                  ...
                  <td class="project-actions">
                    <a class="btn btn-info btn-sm" href="{{ URL('industries/'.$industryDetail->id.'/edit')}}">
                      <i class="fa fa-pencil">
                      </i>
                      Edit
                    </a>
                    <a class="btn btn-danger btn-sm" href="#" onclick="set_del({{ $industryDetail->id }})" data-toggle="modal" data-target="#myModal">
