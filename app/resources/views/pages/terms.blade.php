...
<style>
  ...
  top: 0 !important; /* Adjust the value as needed based on your desired sticky position */
}
</style>
<section class="heightof_section p-and-p table-o-c ">
                    ...
                    <div class="col-md-4 pr-col">
                        <div class="ban-lft">
                            <div class="ban-hdr">
                                <h1>
                                    TERMS &<br />
                                    <span><em>CONDITIONS</em> </span>
                                </h1>
                                <p>Last updated <em> Nov 21, 2023</em></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 pr-col2">
                        <div class="ban-rgt">
                            <figure class="text-start">
                                <img src="{{asset('assets/fe/images/privacy-bak.png')}}" alt="" class="desktop-v" />
                                <img src="{{asset('assets/fe/images/priv-mobile.png')}}" alt="" class="mobile-v private-ban-img" />
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <section class="privacy-sec cmn-gap">
        <div class="container">
            <div class="solution-we-offer-tab-section">
                <div id="parentHorizontalTab">


                    <div class="row">
                        <div class="col-md-3 ">
                            <div class="pri-lft sticky-column">
                                <ul class="resp-tabs-list hor_1">
                                    <li><a href="#ppsection1">OUR SERVICES</a></li>
                                    <li><a href="#ppsection2">INTELLECTUAL PROPERTY RIGHTS</a></li>
                                    <li><a href="#ppsection3">USER REPRESENTATIONS</a></li>
                                    <li><a href="#ppsection4"> USER REGISTRATION</a></li>
                                    <li><a href="#ppsection5">PURCHASES AND PAYMENT</a></li>
                                    <li><a href="#ppsection6">CANCELLATION</a></li>
                                    <li><a href="#ppsection7">PROHIBITED ACTIVITIES</a></li>
                                    <li><a href="#ppsection8">USER GENERATED CONTRIBUTIONS</a></li>
                                    <li><a href="#ppsection9">CONTRIBUTION LICENSE</a></li>
                                    <li><a href="#ppsection10">SOCIAL MEDIA</a></li>
                                    <li><a href="#ppsection11">SERVICES MANAGEMENT</a></li>
                                    <li><a href="#ppsection12">PRIVACY POLICY</a></li>
                                    <li><a href="#ppsection13">COPYRIGHT INFRINGEMENTS</a></li>
                                    <li><a href="#ppsection14">TERM AND TERMINATION</a></li>
                                    <li><a href="#ppsection15">MODIFICATIONS AND INTERRUPTIONS</a></li>
                                    <li><a href="#ppsection16">GOVERNING LAW</a></li>
                                    <li><a href="#ppsection17">DISPUTE RESOLUTION</a></li>
                                    <li><a href="#ppsection18">CORRECTIONS</a></li>
                                    <li><a href="#ppsection19">DISCLAIMER</a></li>
                                    <li><a href="#ppsection20">LIMITATIONS OF LIABILITY</a></li>
                                    <li><a href="#ppsection21">INDEMNIFICATION</a></li>
                                    <li><a href="#ppsection22">USER DATA</a></li>
                                    <li><a href="#ppsection23">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                                    <li><a href="#ppsection24">CALIFORNIA USERS AND RESIDENTS</a></li>
                                    <li><a href="#ppsection25">MISCELLANEOUS</a></li>
                                    <li><a href="#ppsection26">CONTACT US</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="masthead-splash resp-tab-content-commmon">
                                <h3>AGREEMENT TO OUR LEGAL TERMS</h3>
                                <p> We are Purple Stairs LLC ("Company," "we," "us," "our"), a company registered in New Jersey, United States at 20 Bridgewood Ave, Lakewood, NJ 08701.</p>
                                <ul class="ul-type-pp mb-1">
                                    <li>We operate the website Purplestairs.com (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</li>
                                    <li>You can contact us by phone at
                                        <a href="(732) 301-4993">(732) 301-4993</a>, email at <a href="Info@purplestairs.com">Info@purplestairs.com</a>, or by mail to 20 Bridgewood Ave, Lakewood, NJ 08701, United States.</li>
                                </ul>
                                <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Purple Stairs LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                                <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="Info@purplestairs.com">Info@purplestairs.com</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.he Services are intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to use or register for the Services.</p>

                                <section class="table-o-c mt-4">
                            ...
                            <div class="resp-tabs-container- hor_1">
                                <div>
                                    <div class="masthead-splash-content-info mt-5" id="ppsection1">
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection2">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="Info@purplestairs.com">Info@purplestairs.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection3">

                                        <div class="variety-location">

                                            <h3 class="mt-4">3. USER REPRESENTATIONS</h3>
                                            <p><em>By using the Services, you represent and warrant that: (1) all registration information you submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and promptly update such registration information as necessary; (3) you have the legal capacity and you agree to comply with these Legal Terms; (4) you are not a minor in the jurisdiction in which you reside; (5) you will not access the Services through automated or non-human means, whether through a bot, script or otherwise; (6) you will not use the Services for any illegal or unauthorized purpose; and (7) your use of the Services will not violate any applicable law or regulation.</em>
                                            </p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection4">

                                        <div class="variety-location">

                                            <h3 class="mt-4">4. USER REGISTRATION</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection5">

                                        <div class="variety-location">

                                            <h3 class="mt-4">5. PURCHASES AND PAYMENT</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection6">

                                        <div class="variety-location">

                                            <h3 class="mt-4">6. CANCELLATION</h3>
                                            <p><em>All purchases are non-refundable. You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term.</em>
                                            </p>
                                            <p>If you are unsatisfied with our Services, please email us at <a href="Info@purplestairs.com">Info@purplestairs.com</a> or call us at <a href="tel:(732) 301-4993">(732) 301-4993</a>.</p>
                                        </div>
                                    </div>

                                    <div class="masthead-splash-content-info mt-5" id="ppsection7">

                                        <div class="variety-location">

                                            <h3 class="mt-4">7. PROHIBITED ACTIVITIES</h3>
                                            <p><em>You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</em>
                                            </p>
                                            ...
                                            <ul class="ul-type-pp ">
                                                ...
                                                <li>Sharing Account With Others.</li>
                                                <li>Accessing someone else’s account to view additional hidden profiles.</li>
                                            </ul>
                                        </div>
                                    </div>

                                    <div class="masthead-splash-content-info mt-5" id="ppsection8">

                                        <div class="variety-location">

                                            <h3 class="mt-4">8. USER GENERATED CONTRIBUTIONS</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection9">

                                        <div class="variety-location">

                                            <h3 class="mt-4">9. CONTRIBUTION LICENSE</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection12">
                                        <div class="variety-location">
                                            <h3 class="mt-4">12. PRIVACY POLICY</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection13">
                                        <div class="variety-location">
                                            <h3 class="mt-4">13. COPYRIGHT INFRINGEMENTS</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection14">
                                        <div class="variety-location">
                                            <h3 class="mt-4">14. TERM AND TERMINATION</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection15">
                                        <div class="variety-location">
                                            <h3 class="mt-4">15. MODIFICATIONS AND INTERRUPTIONS</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection16">
                                        <div class="variety-location">
                                            <h3 class="mt-4">16. GOVERNING LAW</h3>
                                            <p>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of New Jersey applicable to agreements made and to be entirely performed within the State of New Jersey, without regard to its conflict of law principles.</p>
                                        </div>
                                    </div>
                                    <div class="masthead-splash-content-info mt-5" id="ppsection17">
                                        <div class="variety-location">
                                            <h3 class="mt-4">17. DISPUTE RESOLUTION</h3>
                                            <p><b>Informal Negotiation</b></p>
                                            ...
                                            <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the  state and federal courts located in Monmouth, New Jersey, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection18">
                                        <div class="variety-location">
                                            <h3 class="mt-4">18. CORRECTIONS</h3>
                                            <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
                                        </div>
                                    </div>
                                    <div class="masthead-splash-content-info mt-5" id="ppsection19">
                                        <div class="variety-location">
                                            <h3 class="mt-4">19. DISCLAIMER</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection20">
                                        <div class="variety-location">
                                            <h3 class="mt-4">20. LIMITATIONS OF LIABILITY</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection21">
                                        <div class="variety-location">
                                            <h3 class="mt-4">21. INDEMNIFICATION</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection22">
                                        <div class="variety-location">
                                            <h3 class="mt-4">22. USER DATA</h3>
                                            <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="masthead-splash-content-info mt-5" id="ppsection23">
                                        <div class="variety-location">
                                            <h3 class="mt-4">23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection24">
                                        <div class="variety-location">
                                            <h3 class="mt-4">24. CALIFORNIA USERS AND RESIDENTS</h3>
                                            <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at <a href="tel:(800) 952-5210">(800) 952-5210</a> or <a href="tel:(916) 445-1254">(916) 445-1254</a>.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="masthead-splash-content-info mt-5" id="ppsection25">
                                        <div class="variety-location">
                                            <h3 class="mt-4">25. MISCELLANEOUS</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection26">
                                        <div class="variety-location">
                                            <h3 class="mt-4">25. CONTACT US</h3>
                                            ...
                                            <p>
                                                <b>Purple Stairs LLC</b><br>
                                                <b>20 Bridgewood Ave</b><br>
                                                <b>Lakewood, NJ 08701</b><br>
                                                <b>United States</b><br>
                                                <b>Phone: <a href="tel:(732) 301-4993">(732) 301-4993</a></b><br>
                                                <b><a href="">info@purplestairs.com</a></b>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div>
                                    <div class="masthead-splash-content-info">
                                        <div class="variety-location">
                                            <h3>Maecenas vulputate justo consectetur viverr</h3>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                Suspendisse feugiat, dui sit amet pellentesque tempor,
                                                urna libero aliquet ex, eu tempor leo dui nec leo.
                                                Donec dui nunc, maximus vitae lectus volutpat, aliquet
                                                lacinia ex. Phasellus blandit nisl quis nisi
                                                consectetur, nec euismod nibh malesuada.
                                            </p>
                                            <h4>Donec dui nunc maximus</h4>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit. Maecenas vulputate justo consectetur viverra
                                                rutrum. Aliquam at sodales odio, non hendrerit quam.
                                            ...
                                            <h4>Phasellus blandit nisl quis nisi</h4>
                                            <p>
                                                Aliquam at sodales odio, non hendrerit quam.
                                                Pellentesque habitant morbi tristique senectus et
                                                netus et malesuada fames ac turpis egestas.
                                                Suspendisse feugiat, dui sit amet pellentesque tempor,
                                                urna libero aliquet ex, eu tempor leo dui nec leo.
                                            ...
                                            <h4>Maecenas eget libero et metus</h4>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit. Maecenas vulputate justo consectetur viverra
                                                rutrum. Aliquam at sodales odio, non hendrerit quam.
