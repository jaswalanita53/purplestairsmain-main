                    ...
                    <div class="col-md-4 pr-col">
                        <div class="ban-lft">
                            <div class="ban-hdr">
                                <h1>
                                    Privacy <br />
                                    <span><em>Policy</em> </span>
                                </h1>
                                <p>Last updated <em> July 25, 2023</em></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3 ">
                            <div class="pri-lft sticky-column">
                                <ul class="resp-tabs-list hor_1">
                                    <li><a href="#ppsection1">WHAT INFORMATION DO WE COLLECT?</a></li>
                                    <li><a href="#ppsection2">HOW DO WE PROCESS YOUR INFORMATION?</a></li>
                                    <li><a href="#ppsection3">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
                                    <li><a href="#ppsection4">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
                                    <li><a href="#ppsection5">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
                                    <li><a href="#ppsection6">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
                                    <li><a href="#ppsection7">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
                                    <li><a href="#ppsection8">DO WE COLLECT INFORMATION FROM MINORS?</a></li>
                                    <li><a href="#ppsection9">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
                                    <li><a href="#ppsection10">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
                                    <li><a href="#ppsection11">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
                                    <li><a href="#ppsection12">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
                                    <li><a href="#ppsection13">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
                                    <li><a href="#ppsection14">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="masthead-splash resp-tab-content-commmon">
                                ...
                                <p> This privacy notice for Purple Stairs ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:</p>
                                <ul class="ul-type-pp mb-1">
                                    <li>Visit our website at http://www.purplestairs.com, or any website of ours that links to this privacy notice</li>
                                    <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                                </ul>
                                <p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at info@purplestairs.com.</p>

                                <section class="summary">
                                    <h3 class="mt-4">SUMMARY OF KEY POINTS</h3>
                                    ...
                                    <p>How do you exercise your rights? The easiest way to exercise your rights is by visiting http://www.purplestairs.com, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
                                </section>
                                ...
                                <div>
                                    <div class="masthead-splash-content-info mt-5" id="ppsection1">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <p class="mb-0">Personal Information Provided by You. The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make, and the products and features you use. The personal information we collect may include the following:
                                            <ul class="ul-type-pp ">
                                                <li>Names</li>
                                                <li>Phone Numbers</li>
                                                ...
                                                <li>Resume and Personal Information</li>
                                            </ul>
                                            Sensitive Information. We do not process sensitive information.
                                            </p>
                                            <p>Payment Data. We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is stored by Banquest.</p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection2">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <p><em>In Short: We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent.</em>
                                            </p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection3">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
                                            <p><em>In Short: We may share information in specific situations described in this section and/or with the following third parties. </em>
                                            </p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection4">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection5">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
                                            <p><em>In Short: If you choose to register or log in to our Services using a social media account, we may have access to certain information about you. </em>
                                            </p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection6">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
                                            <p><em>In Short: We keep your information for as long as necessary to fulfill the purposes outlined in this privacy notice unless otherwise required by law.</em>
                                            </p>
                                            <p>We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting, or other legal requirements). No purpose in this notice will require us keeping your personal information for longer than __________ months past the termination of the user's account </p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection7">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
                                            <p><em>In Short: We aim to protect your personal information through a system of organizational and technical security measures.</em>
                                            </p>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection8">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">8. DO WE COLLECT INFORMATION FROM MINORS?</h3>
                                            <p><em>In Short: We do not knowingly collect data from or market to children under 18 years of age.</em>
                                            </p>
                                            <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at info@purplestairs.com.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection9">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
                                            <p><em>In Short: You may review, change, or terminate your account at any time.</em>
                                            </p>
                                            ...
                                            <p>If you have questions or comments about your privacy rights, you may email us at info@purplestairs.com.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection10">
                                        ...
                                        <div class="variety-location">
                                            ...
                                            <h3 class="mt-4">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection11">
                                        <div class="variety-location">
                                            <h3 class="mt-4">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
                                            <p><em>In Short: If you are a resident of California, Colorado, Connecticut or Virginia, you are granted specific rights regarding access to your personal information.</em></p>
                                            <p>What categories of personal information do we collect?</p>
                                            <p>We have collected the following categories of personal information in the past twelve (12) months:</p>
                                            <table class="border  table pp-table">
                                                <tr>
                                                    <th>Category</th>
                                                    <th>Examples</th>
                                                    <th>Collected</th>
                                            ...
                                            <h3 class="mt-4">California Residents</h3>
                                            ...
                                            <ul>
                                                <li class="pl-5">(1) every individual who is in the State of California for other than a temporary or transitory purpose and</li>
                                                <li class="pl-5">(2) every individual who is domiciled in the State of California who is outside of the State of California for a temporary or transitory purpose</li>
                                            </ul>
                                            ...
                                            <p>To exercise these rights, you can contact us by visiting <a href="http://www.purplestairs.com">http://www.purplestairs.com</a>, by emailing info@purplestairs.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
                                            <h3 class="mt-4">Colorado Residents</h3>
                                            ...
                                            <p>To submit a request to exercise these rights described above, please email info@purplestairs.com or visit http://www.purplestairs.com.</p>
                                            <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at info@purplestairs.com. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
                                            <h3 class="mt-4">Connecticut Residents</h3>
                                            ...
                                            <p>To submit a request to exercise these rights described above, please email info@purplestairs.com or visit <a href="http://www.purplestairs.com">http://www.purplestairs.com</a>.</p>
                                            <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at info@purplestairs.com. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
                                            <h3 class="mt-4">Virginia Residents</h3>
                                            ...
                                            <p>You may contact us by email at info@purplestairs.com or visit <a href="http://www.purplestairs.com">http://www.purplestairs.com</a>.</p>
                                            ...
                                            <p>
                                            <ul>Right to appeal</ul>
                                            </p>
                                            <p>If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. If you wish to appeal our decision, please email us at info@purplestairs.com. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal if denied, you may contact the <a target="_blank" href="https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint">Attorney General to submit a complaint</a>.</p>
                                        </div>
                                    </div>

                                    <div class="masthead-splash-content-info mt-5" id="ppsection12">
                                        <div class="variety-location">
                                            <h3 class="mt-4">12. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection13">
                                        <div class="variety-location">
                                            <h3 class="mt-4">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
                                            <p>If you have questions or comments about this notice, you may email us at info@purplestairs.com or contact us by post at:</p>
                                            <address>
                                                20 Bridgewood Ave<br>
                                                Lakewood NJ 08701<br>
                                                United States<br>
                                                phone : <b>(732) 301-4993</b>
                                            </address>
                                        </div>
                                    </div>
                                    ...
                                    <div class="masthead-splash-content-info mt-5" id="ppsection14">
                                        <div class="variety-location">
                                            <h3 class="mt-4">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
                                            <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <a href="http://www.purplestairs.com" target="_blank">http://www.purplestairs.com</a>.
                                            </p>
                                             </div>
                                    </div>
                                </div>
