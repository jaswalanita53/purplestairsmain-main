                                    ...
                                    <td style="width: 25%">
                                        <div class="preview_banner_img_sec_left">
                                            <figure class="@if (empty($user->profile_photo_path)) main_img_masked @endif"
                                                style="z-index:9;">
                                                @if (!empty($user->profile_photo_path)/* && $personal->profile_status == 1*/)
                                                    <img src="{{ asset($user->profile_photo_path) }}"
                                                        alt="" />
                                                @else
                                                    <img src="{{ asset('assets/fe/images/profile-pic.png') }}"
                                                ...
                                                <div class="defination-sec">
                                                    ...
                                                    <div class="title-">
                                                        <p>
                                                            Current Position:
                                                            <span>
                                                                @if ($mode && $personal->current_title_status == 0)
                                                                    <img src="{{ asset('/assets/be/images/blur1.png') }}">
                                                                @else
                                                                                    ...
                                                                                    <td class="">
                                                                                        <div class="contact_rgt_side blured_txt" style="margin-left:5px;">
                                                                                           @php
                                                                                            ...
                                                                                            @endphp
                                                                                            <a href="{{ $personal->additional_url }}" target="_blank" style="font-size:13px;word-break: break-word;">{{ $personal->additional_url }}</a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="contact_rgt_side blured_txt" style="margin-left:5px;">
                                                                                            ...
                                                                                            @endphp
                                                                                            <a href="{{ $personal->linkedin_url }}" target="_blank" style="font-size:13px;word-break: break-word;">{{ $personal->linkedin_url }}</a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                        ...
                                                        <div class="work_list_inner" {{-- style="margin-bottom: 10px;" --}}
                                                            ...
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: baseline;padding-top:5px;">
                                                                        <span
                                                                            style=" font-weight: 400; ;font-size: 12px;    margin: 0;">
                                                                            @if($mode && $employement->start_year_status == 0)
                                                                                <img src="{{ asset('/assets/be/images/blur1.png') }}">
                                                                            @else
                                                            ...
                                                            @if ($employement->responsibilities != '')
                                                                <div class="work_list_inner_txt">
                                                                    ...
                                                                    {{-- task - 86a0hfdhj --}}
                                                                    <p>
                                                                        @if($mode && $employement->responsibilities_status == 0)
                                                            ...
                                                            @if ($employement->accomplishments != '')
                                                                <div class="work_list_inner_txt">
                                                                    <h6 class="main-resume-head">Position
                                                                        Accomplishments</h6>
                                                                    <p>
                                                                        @if($mode && $employement->accomplishments_status == 0)
                                                                            <img src="{{ asset('/assets/be/images/blur2.png') }}">
                                                                        @else
                                                                          {!! nl2br(replaceEmojisWithDashes($employement->accomplishments))!!}
                                                                        @endif
                                                                    </p>
                                                                </div>
                                                            @endif
                                                        ...
                                                        <div class="work_list_inner"
                                                            ...
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: baseline;padding-top:5px;">
                                                                        <span class="{{ ($mode && $education->start_year_status == 0) ? 'blured_txt' : '' }}"
                                                                            style=" font-weight: 400; font-size: 12px;    margin: 0;">
                                                                            @if($mode && $education->start_year_status == 0)
                                                                                <img src="{{ asset('/assets/be/images/blur1.png') }}">
                                                                            @else
                                                            ...
                                                            @if ($education->course_description != '')
                                                                <p class="">
                                                                    @if($mode && $education->course_description_status == 0)
                                                                    <img src="{{ asset('/assets/be/images/blur2.png') }}">
                                                                    @else
